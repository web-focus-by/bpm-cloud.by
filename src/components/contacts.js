...
const Contacts = () => {
    ...
    const data = [
      ...
      "которая обеспечит высокое качество и скорость работ. К каждому проекту мы сохраняем индивидуальный подход. Уточняем все необходимые детали,"+
      "разрабатываем в соответствии требованиям заказчика, согласованному бюджету и установленным срокам."},
